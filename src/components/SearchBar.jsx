...
export default function SearchBar() {
    ...
    return (
        <form className="w-2/3 h-10 flex flex-row justify-between items-center p-4 my-8 border-2 border-black rounded-full bg-transparent md:w-1/2 md:h-12 xl:w-1/3"
